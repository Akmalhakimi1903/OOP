...
public class Staff extends Person {
    ...
    private static VisitLogManager visitLogManager = new VisitLogManager();
    private static List<Patient> patientList = Patient.createDummyPatients();

    // Constructor
    public Staff(int staffId, String password, String name, String role, String phoneNumber) {
    ...
    public void manageVisitorCheckInOut(Scanner input) {
        ...
        System.out.println("|                  Visitor Check-In/Check-Out          |");
		System.out.println("________________________________________________________");
