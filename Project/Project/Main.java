...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println("|     HVMS System     |");
            System.out.println("| ____________________|");
    ...
    public static void staffLogin(Scanner input) {
        ...
        // Create an example staff for demonstration purposes
        Staff staff = new Staff(1, "1", "MOHAMAD SYAIFULLAH BIN MOKHTAR ", "Admin", "0123456789");
